...
<head>
    ...
    <title>vticket</title>
    <meta name="description" content="Ticket virtuel pour le projet de ODC">
...
<body>
        ...
        <div class="sufee-alert alert with-close alert-success alert-dismissible fade show" style="z-index:1000;">
